...
namespace backend\MenuBundle\Entity;
 ...
 * Menu.menu
 *
 * @ORM\Table(name="menu.menu")
 * @ORM\Entity(repositoryClass="backend\MenuBundle\Entity\MenuRepository")
 */
class Menu
{
    /**
     ...
     * Set padre
     *
     * @param \backend\MenuBundle\Entity\Menu $padre
     * @return Menu
     */
    public function setPadre(\backend\MenuBundle\Entity\Menu $padre = null)
    {
        $this->padre = $padre;
     ...
     * Get padre
     *
     * @return \backend\MenuBundle\Entity\Menu
     */
     ...
     * @return Menu
     */
    public function addHijo(\backend\MenuBundle\Entity\Menu $hijos)
    {
        $this->hijos[] = $hijos;
