...
//        return \backend\ComunBundle\Util\UtilRepository2::getContainer()->get('request')->getSession()->get('poderJudicial');
    }
...
//    {
//        $idUser = \backend\ComunBundle\Util\UtilRepository2::getContainer()->get('security.context')->getToken()->getUser()->getId();
//        if($object)
//            return \backend\ComunBundle\Util\UtilRepository2::getEntityManager()->find('SeguridadBundle:Usuario',$idUser)->getPersonanatural();
//        return \backend\ComunBundle\Util\UtilRepository2::getEntityManager()->find('SeguridadBundle:Usuario',$idUser)->getPersonanatural()->getId();
//    }
    ...
    {
        return \backend\ComunBundle\Util\UtilRepository2::getContainer()->get('doctrine.orm.entity_manager');
    }
    /**
