...
use Security\MySecurityBundle\Enums\EGroup;
 ...
 * @ORM\Entity(repositoryClass="Security\MySecurityBundle\Repository\UsuarioRepository")
 */
class Usuario extends User
{
    ...
    protected $groups;
    /**
     * @var \backend\ComunBundle\Entity\Participante
     *
     * @ORM\OneToMany(targetEntity="backend\ComunBundle\Entity\Participante",mappedBy="usuario")
     */
    private $profesor;
...
//        ldd('paco');
  ...
  /**
     ...
     * Add permisos
     *
     * @param \Security\MySecurityBundle\Entity\Permission $permisos
     * @return Usuario
     */
    public function addPermiso(\Security\MySecurityBundle\Entity\Permission $permisos)
    {
     ...
     * @param \Security\MySecurityBundle\Entity\Permission $permisos
     */
    public function removePermiso(\Security\MySecurityBundle\Entity\Permission $permisos)
    {
     ...
     * Set profesor
     *
     * @param \backend\ComunBundle\Entity\Profesor $profesor
     * @return Usuario
     */
    public function setProfesor(\backend\ComunBundle\Entity\Participante $profesor = null)
    {
     ...
     * Get profesor
     *
     * @return \backend\ComunBundle\Entity\Profesor $profesor
     */
