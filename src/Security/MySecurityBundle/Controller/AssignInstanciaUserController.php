...
use Security\MySecurityBundle\Entity\Grupo;
use Security\MySecurityBundle\Entity\Usuario;
use Security\MySecurityBundle\EP\UserInstanceEP;
use Security\MySecurityBundle\Form\GroupType;
use Security\MySecurityBundle\Form\UsuarioInstanciaType;
use Security\MySecurityBundle\MySecurityBundle;
use Security\MySecurityBundle\TableDescription\GroupRutas;
use Security\MySecurityBundle\TreeDescription\GroupPermissionTree;
use Symfony\Component\Config\Definition\Exception\Exception;
use Symfony\Component\HttpFoundation\JsonResponse;

class AssignInstanciaUserController extends MyCRUDController
{
    protected $type = 'backend\MySecurityBundle\Form\UsuarioInstanciaType';
