...
use Security\MySecurityBundle\Entity\Usuario;
use Security\MySecurityBundle\Form\EstablishPassType;
use Security\MySecurityBundle\Form\UsuarioEditType;
use Security\MySecurityBundle\Form\UsuarioType;
use Security\MySecurityBundle\TableDescription\UserGroupTable;
use Security\MySecurityBundle\TableDescription\UsuarioRutas;
use Security\MySecurityBundle\TreeDescription\UserPermissionTree;
...
{
    protected $type = 'Security\MySecurityBundle\Form\UsuarioType';
    protected $editType = 'Security\MySecurityBundle\Form\UsuarioEditType';
